...
That was exactly why it should not have been merged as-is into the bundled app. Shreyas pointed out in the [pull request discussion](https://github.com/TechnitiumSoftware/DnsServer/pull/1580) that the rewrite was not backward compatible and that the existing app was already deployed widely enough for an immediate break to matter. Keeping the upstream version stable was the right decision for the main project. Continuing the newer version separately was the right decision for me. It now lives as [LogExporterApp](https://github.com/DeltaZulu-OU/LogExporterApp).
