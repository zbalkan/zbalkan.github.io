...
There is an additional effect that amplifies this pattern. Large language models tend to be agreeable. Studies show that they affirm user positions significantly more often than humans, even when those positions are questionable or incorrect ([Stanford News, 2026](https://news.stanford.edu/stories/2026/03/ai-advice-sycophantic-models-research); [arXiv:2411.15287](https://arxiv.org/html/2411.15287v1)). This is not only a presentation issue. It creates a feedback loop. A proposed solution Y is not only generated, but also validated. That validation increases confidence in Y, which makes it more likely to be propagated without further questioning. Over time, this produces a reinforcing cycle where plausible solutions are accepted more quickly, challenged less often, and carried further into implementation before the underlying problem X is examined ([Scientific American, 2026](https://www.scientificamerican.com/article/ai-chatbots-are-sucking-up-to-you-with-consequences-for-your-relationships/)).
...
Just to ensure I made my point straight, I must note that this is not only a communication issue: *Repeated acceptance of Y without validating X accumulates into systemic degradation over time.*[^1]
...
[^1]: I found this article after the initial publication of the blog and it completes my views. I suggest you to have a look. [Slop Creep: The Great Enshittification of Software](https://boristane.com/blog/slop-creep-enshittification-of-software/)
