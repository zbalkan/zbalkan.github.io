...
- DPO has to have the authority to access personal data and processing operations within the organisation.
...
The high-level -yet sufficiently specific- requirements allow flexibility for the organisations to structure their environment along with modifying their processes. But they also cause ambiguity. That is where case laws shine.
...
- **Functional Approach:** Lower-level positions in the organisational hierarchy that still have the authority to define the objectives and methods of data processing.
...
The DPA concluded that merging the roles of the DPO and the director in charge of audit, risk, and compliance within the organisation inherently leads to a situation where the individual sets the goals and methods for data processing. This makes independent oversight unfeasible, thereby constituting a clear conflict of interest based on the formal approach.

In sum, the DPO should not be tasked with the conflicting responsibilities of both *establishing the organisation's data protection policies* and simultaneously *assessing whether these policies comply* with legal regulations.
...
> **Purpose**
>
> To ensure someone with sufficient authority and responsibility is actively managing and championing the organisation’s information security program, accountability and responsibility for information security needs to be assigned at the executive level within an organisation.
>
...
> Per Requirement 12.1.4, responsibility for information security is assigned to a member of executive management with a CISO title, or if they do not have a CISO title, then that person has information security knowledge similar to what someone with a CISO title has. As the guidance column for this requirement states, "Accountability and responsibility for information security needs to be assigned at the executive level within an organisation. Common executive management titles for this role include Chief Information Security Officer." If the CISO in an organisation is not responsible or accountable for the information security program, then there is flexibility in this requirement to allow it to be met by another executive-level role within an organisation that does have that responsibility.
...
However, I would like to mention a term PCI DSS requirements use very often: Organisational Independence. It is a term close to the conflict of interest:

> An organisational structure that ensures there is no conflict of interest between the person or department performing the activity and the person or department assessing the activity.

According to PCI DSS 4.0, Organisational Independence is required for vulnerability scanners and penetration testers. So, no, it does not cover the executive manager's role who is responsible for security.
...
Therefore, an organisation can appoint a CIO/CTO/CSO/CFO/CHRO without considering a conflict of interest as long as the organisation can prove that the appointed person has "provable information security knowledge". The knowledge is vague but it is up to the QSA to decide if the proof of knowledge is sufficient.

------
**Trivia time:**

Q1: *If a CTO had participated in CTFs in college, can the organisation fulfil requirement 12.1.4?*
...
Q2: *If the organisation is part of a larger group, how can the organisation fulfil requirement 12.1.4?*
...
- authority on business decisions to fulfil the responsibilities, etc.
...
Q3: *If a company assigns the CISO as a DPO by properly meeting the GDPR requirements, would the organisation be able to comply with PCI DSS?*

A3: **No.** *Because a CISO assigned as a DPO based on the GDPR requirements has no authority, responsibility, and accountability. The CISO's role is advisory, and the security responsibility belongs to the company management. So this situation does not fulfil the requirements of PCI DSS.*
