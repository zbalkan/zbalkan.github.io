---
title: "Wazuh, Splunk, and Detection Engineering"
tags:
...
I tend to reduce that whole discussion to a simple duck test:

> If it ingests telemetry, normalises it, runs detection logic, and produces alerts analysts triage, it is a SIEM.

The naming changes. The responsibilities do not.

I will write separately about the actual content of the Wazuh and Splunk comparison, because that deserves its own article. This is just a short note on the lecture itself.

I am grateful to the students for their time and engagement. I hope I managed to be useful, even in a small way, to people who will be the next generation of cybersecurity professionals. And many thanks to Dr. Stephen Urs Fedtke for the invitation and the opportunity to contribute to the course.
